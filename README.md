# BLOCSIE
**BLOCSIE** - **B**enchmark for **LOC**alization in a **S**imulated **I**ndustrial **E**nvironment
...
[https://drive.google.com/file/d/1koVoI8hh0QAry02isOlENKvnfQ_PISZm/viewImport](https://drive.google.com/file/d/1kiy-Ao48dVKFo9Hv-bqa2lqVNuO40mF2/view?usp=drive_link) and install package in Unity
...
Play the rosbags to your algorithm and ensure that they you write the outputs in the format timestamp, x, y, z, qx, qy, qz, qw (each separated by a whitespace). Next you can use the gui to evaluate your results.
